...
if(isset($_POST['send']))
{
    ...
    $query="INSERT INTO( ticket (Firstname,Lastname,Gender,Email,Contact,concertdetails,time) VALUES(?,?,?,?,?,?,now())";
   $result=mysqli_query($conn,"INSERT INTO ticket (Firstname,Lastname,Gender,Email,Contact,concertdetails,time) VALUES('$firstname','$lastname','$gender','$email','$tel','$details',now())");
    /*$stmt=mysqli_prepare($conn,$query);
    if($stmt)
    {
        mysqli_stmt_bind_param($stmt,"ssssss",$firstname,$lastname,$gender,$email,$tel,$details);
        mysqli_stmt_execute($stmt);
        $result=mysqli_stmt_get_result($stmt);*/
        if($result)
        {
            $error="Your ticket is booked!";
    ...
    <div class="sub-menu-1">
      <ul>
        ...
        <form action="<?php htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post">
            ...
            <p><center><b>Fill out this form to Book concert ticket.</b></center></p><br>
              <br>
            <p><b>Full name:</b><input type="text"name="fn"placeholder="Type your name"size="60"> 
                <br>
            ...
            <br>
          <br>
                <b>Email/contact:</b><input type="text"name="email"placeholder="Type your email or contact"size="60">
                <br>               
                <b>Concert details:</b><input type="text"name="details"placeholder="Venue/date"size="30">
                <br>
